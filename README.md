...
Minecraft Java Edition 26.2용 Fabric 모드입니다. 화면에 표시되는 비루트 발전과제 완료 수에 따라 오버월드, 네더, 엔드의 월드보더를 함께 확장하거나 축소합니다. 확장 중에는 보더가 초록색으로 표시되며, 설정된 시간이 지나 확장이 끝나면 다시 파란색으로 표시됩니다.
...
- `/advboard config expansionDurationSeconds <seconds>`: 보더 확장 시간을 초 단위로 변경하고 저장합니다.
